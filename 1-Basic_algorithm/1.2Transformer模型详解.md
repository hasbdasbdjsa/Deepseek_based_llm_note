...
![transformer](C:\Users\allen\Desktop\deepseek\1-Basic_algorithm\image\transformer.png)

Nx=6，Encoder block由6个encoder堆叠而成，图中的一个框表示的是一个encoder的内部结构，一个encoder由MHA和FFN组成。编码器在结构上是相同的，但是之间没有共享参数。

![The_transformer_encoder_decoder_stack](C:\Users\allen\Desktop\deepseek\1-Basic_algorithm\image\The_transformer_encoder_decoder_stack.png)

![transformer_resideual_layer_norm_3](C:\Users\allen\Desktop\deepseek\1-Basic_algorithm\image\transformer_resideual_layer_norm_3.png)
